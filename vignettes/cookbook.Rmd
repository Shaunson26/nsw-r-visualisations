...
```{r}
p1 +
  scale_colour_discrete(palette = pal_nswtheme("qual", var = "aboriginal")) +
  theme_nswtheme()
```
...
```{r}
p2 +
  discrete_scale("fill", palette = pal_nswtheme("pairs")) +
  theme_nswtheme()
```
...
p5 +
  discrete_scale(
    "fill",
    palette = pal_nswtheme("div", "red", cvd = TRUE) |> pal_stretch(),
    breaks = sentiment
  ) +
  theme_nswtheme(base_size = 12)
```
